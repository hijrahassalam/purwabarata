...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <title>Purwabarata Web Management</title>
...
<link href="<?php echo base_url();?>assets/bootstrap.min.css" rel="stylesheet" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous">
  ...
  <body class="text-center" style="background:url(<?php echo base_url();?>assets/symphony.png)">
    <?php
      if (isset($error)){
        echo $error;
    }
  ...
  <img class="mb-4" src="<?php echo base_url();?>assets/rsz_1logo.png" alt="" width="72" height="72">
  <h1 class="h3 mb-3 font-weight-normal">Purwabarata Web Management</h1>
  ...
  <p class="mt-5 mb-3 text-muted">© TIM BELANTOSURO - PKKMB UNS 2019</p>
</form>
